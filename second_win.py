...
class TestWin(QWidget):
    ...
    def initUI(self):
        ...
        self.button_nwxt = QPushButton(txt_sendresults)
        ...
        self.l_line.addWidget(self.button_nwxt, alignment=Qt.AlignCenter)
    ...
    def connects(self):
        self.button_nwxt.clicked.connect(self.next_click)
